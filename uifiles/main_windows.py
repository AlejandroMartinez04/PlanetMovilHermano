...
class Ui_ListProductForm(object):
...
"}")
        ...
        self.labelQty.setGeometry(QRect(10, 10, 144, 17))
        ...
        icon2 = QIcon()
        icon2.addFile(u"../assets/newicons/Devolucion.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.devolverButton.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u"../assets/newicons/Ganancias.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.gananciasButton.setIcon(icon3)
        self.gananciasButton.setIconSize(QSize(120, 50))
        ...
        self.escanearButton.setInputMethodHints(Qt.InputMethodHint.ImhNone)
        icon4 = QIcon()
        icon4.addFile(u"../assets/newicons/icons8-factura-48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.escanearButton.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u"../assets/newicons/icons8-salida-48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.ListSellTable.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        ...
        self.lineEditSell.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        icon6 = QIcon()
        icon6.addFile(u"../assets/newicons/icons8-dinero-48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.sellButton.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u"../assets/newicons/icons8-limpiar-48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.ListProductTable.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        ...
        icon8 = QIcon()
        icon8.addFile(u"../assets/newicons/icons8-agregar-a-carrito-de-compras-48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.addcartButton.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u"../assets/newicons/icons8-vaciar-carro-48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.removecartButton.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u"../assets/newicons/icons8-libro-abierto-48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.inicioButton.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u"../assets/newicons/icons8-m\u00e1s-48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.agregarButton.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u"../assets/newicons/icons8-eliminar-papelera-48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.eliminarButton.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u"../assets/newicons/icons8-editar-48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.editarButton.setIcon(icon13)
